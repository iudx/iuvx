...
mqttServerParams = {}
mqttServerParams["url"] = LB_IP
mqttServerParams["port"] = 1883
mqttServerParams["timeout"] = 60
mqttServerParams["topic"] = [("lbsresponse/archive/add", 0), ("lbsresponse/archive/del", 0), ("lbsresponse/user/add", 0), ("lbsresponse/user/del", 0), ("lbsresponse/dist/add", 0), ("lbsresponse/dist/del", 0), ("lbsresponse/stream/add", 0), ("lbsresponse/stream/del", 0), ("lbsresponse/origin/del",
                                                                                                                                                                                                                                                                                0), ("lbsresponse/origin/add", 0), ("lbsresponse/user/all", 0), ("lbsresponse/origin/all", 0), ("lbsresponse/dist/all", 0), ("lbsresponse/stream/all", 0), ("lbsresponse/archive/all", 0), ("lbsresponse/verified", 0), ("lbsresponse/rtmp", 0), ("lbsresponse/user", 0)]
